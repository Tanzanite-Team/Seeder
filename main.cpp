...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Tanzanite-seeder\n"
...
static const string mainnet_seeds[] = {"127.0.0.1", "207.154.204.86", "178.62.46.38", "188.166.16.5", "138.68.111.62", "207.154.246.95", "167.99.129.4", "165.22.81.124", "46.101.28.223", ""};
static const string testnet_seeds[] = {"127.0.0.1", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 52367), true);
  }
  do {
